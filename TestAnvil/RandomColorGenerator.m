...
+(NSArray *)getColorsArrays {
    UIColor *color0 = [UIColor colorFromHexString:@"FFCB8A"];
    UIColor *color1 = [UIColor colorFromHexString:@"EB9A56"];
    UIColor *color2 = [UIColor colorFromHexString:@"DB482D"];
    UIColor *color3 = [UIColor colorFromHexString:@"571E15"];
